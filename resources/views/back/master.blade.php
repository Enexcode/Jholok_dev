...
<html lang="en">
  <head>
    ...
    <title>@yield('title') - Jholok.dev</title>
    <!-- plugins:css -->
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('project')}}">Laravel Project</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">HTML Project</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Figma To HTML</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
              ...
              <li class="nav-item dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Laravel Project</p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">HTML Projects</p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright 2024 - Jholok.Dev</span>
